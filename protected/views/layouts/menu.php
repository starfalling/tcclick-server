...
<div id="page_menu">
  <dl>
    ...
    <dd><a href="<?php echo TCClick::app()->root_url, 'reportsGooglePlayReferrer', $external_site_id ?>">子渠道分布(安卓)</a>
    </dd>
    <?php if($user && $user->isAdmin()): ?>
      <dd><a href="<?php echo TCClick::app()->root_url, 'reportsExternalSiteMutualDevices', $external_site_id ?>">外部站共有设备</a>
      </dd>
