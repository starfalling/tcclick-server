...
/**
 * 删除过早的用来存储当日活跃设备ID列表的table，以释放数据库空间
 */
...
$from_time = $today-TCCLICK_DAILY_ACTIVE_DEVICE_RECORD_TIME-86400;
$to_time = $today-TCCLICK_DAILY_ACTIVE_DEVICE_RECORD_TIME;
...
for($time=$from_time; $time<$to_time; $time+=86400){
	$table_name = "daily_active_devices_" . date('Y_m_d', $time);
